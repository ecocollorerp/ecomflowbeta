-- ==================================================
-- CONTINUAÇÃO: PARTES 4-8 (CORRIGIDO)
-- ==================================================
...
-- ╔════════════════════════════════════════════════════════════════╗
-- ║ PARTE 6: INSERIR SKU LINKS (MARKETPLACE) - CORRIGIDO            ║
-- ║ SEM as colunas product_code, imported_at, matched_at           ║
-- ╚════════════════════════════════════════════════════════════════╝

INSERT INTO sku_links (imported_sku, master_product_sku, created_at, updated_at)
VALUES 
    ('ML-12345678901', 'PROD-CARTAZ-001', (EXTRACT(EPOCH FROM NOW())::BIGINT * 1000), (EXTRACT(EPOCH FROM NOW())::BIGINT * 1000)),
    ('ML-87654321098', 'PROD-FOLDER-001', (EXTRACT(EPOCH FROM NOW())::BIGINT * 1000), (EXTRACT(EPOCH FROM NOW())::BIGINT * 1000)),
    ('ML-11111111111', 'PROD-BANNER-001', (EXTRACT(EPOCH FROM NOW())::BIGINT * 1000), (EXTRACT(EPOCH FROM NOW())::BIGINT * 1000)),
    ('ML-99999999999', 'PROD-CARTAZ-001', (EXTRACT(EPOCH FROM NOW())::BIGINT * 1000), (EXTRACT(EPOCH FROM NOW())::BIGINT * 1000))
