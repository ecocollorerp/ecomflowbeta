        ...
        <>
            ...
            <div className="mt-8">
                ...
                {materialDeductions.length > 0 && (
                  <div className="mt-8">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50 mb-4">Dedução de Materiais Prevista</h2>
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                      <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700 max-h-60">
                ...
                {generalSettings.dashboard.showStatCards && (
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                        ...
                        <StatCardV2 
                            ...
                            onIndicatorClick={setActiveStatCardIndex}
                        />
                        <div className="bg-white dark:bg-gray-800 p-5 rounded-xl border border-gray-200 dark:border-gray-700 flex-1 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
                            <div className="flex justify-between items-start">
                               <p className="text-gray-500 dark:text-gray-400 font-medium">Funcionários Ativos</p>
                               <div className="p-2 bg-blue-50 dark:bg-blue-900/30 text-blue-900 dark:text-blue-100 rounded-lg"><Users size={20}/></div>
                            </div>
                            <div className="mt-2">
                               <p className="text-3xl font-bold text-gray-900 dark:text-gray-50">{dashboardData.funcionariosAtivos.total}</p>
                               <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Usuários cadastrados no sistema</p>
                            </div>
                        </div>
                    </div>
                )}
                ...
                {generalSettings.dashboard.showActionCards && (
                    <>
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50 mt-8 mb-4">Ações Principais</h2>
                        ...
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50 mt-8 mb-4">Ferramentas e Configurações</h2>
