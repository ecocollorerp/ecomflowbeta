...
const DashboardPage: React.FC<DashboardPageProps> = (props) => {
    ...
    return (
        <>
            <Header filters={filters} onFilterChange={setFilters} onSettingsClick={() => setIsSettingsModalOpen(true)} generalSettings={generalSettings} onExportDailyLog={onExportDailyLog} />
                                        ...
                                        <div className="flex justify-between items-start mb-1">
                                            <div className="pr-8">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {isVolatil && <span className="px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-widest bg-orange-100 text-orange-700 border border-orange-200">Volátil</span>}
                                                </div>
