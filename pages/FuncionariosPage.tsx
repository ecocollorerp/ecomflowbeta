    ...
    return (
        <div>
            <div className="flex justify-between items-start mb-8 flex-wrap gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-50">Gerenciamento de Funcionários</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Controle de presença e ponto da equipe.</p>
                </div>
                <button
                    onClick={() => setIsAddFuncionarioModalOpen(true)}
                    className="flex items-center text-sm font-semibold bg-blue-600 dark:bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-700 dark:bg-blue-600 transition-colors shadow-sm"
                >
            ...
            <div className="mt-8 bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm w-full">
                 <h2 className="text-lg font-bold text-gray-900 dark:text-gray-50 mb-4 flex items-center">
                    ...
                    <table className="min-w-full bg-white dark:bg-gray-800 text-sm">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                            {users.map(user => {
                                ...
                                let statusNode = <span className="text-xs font-semibold text-gray-500 dark:text-gray-400">Aguardando</span>;
                                    ...
                                    <React.Fragment key={user.id}>
                                        <tr className="hover:bg-gray-50 dark:bg-gray-700">
                                            <td className="py-2 px-3 text-center">
                                                <button onClick={() => toggleUserExpansion(user.id)} className="p-1 rounded-full hover:bg-gray-200 dark:bg-gray-600">
                                        ...
                                        {isExpanded && (
                                            <tr className="bg-gray-50 dark:bg-gray-700">
                                                <td colSpan={5} className="p-4">
                                                    <h4 className="text-sm font-bold text-gray-900 dark:text-gray-50 mb-2">Histórico de Ponto</h4>
                                                    {user.attendance && user.attendance.length > 0 ? (
                                                        <div className="overflow-auto max-h-60 border border-gray-200 dark:border-gray-700 rounded-md">
                                                            <table className="min-w-full bg-white dark:bg-gray-800">
                                                                <thead className="bg-gray-200 dark:bg-gray-600 sticky top-0">
                                                                    <tr>
                                                                        <th className="py-1 px-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Data</th>
                                                                        <th className="py-1 px-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Status</th>
                                                                        <th className="py-1 px-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Observações</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                                        ...
                                                        <p className="text-xs text-gray-500 dark:text-gray-400 text-center py-4">Nenhum registro de ponto encontrado.</p>
                                                    )}
                                                </td>
                                            </tr>
                                        )}
